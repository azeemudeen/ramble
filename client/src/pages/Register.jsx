...
function Register() {
  ...
  const handleValidation = () => {
    ...
    if (password !== confirmPassword) {
      errormsgs.push("Password and Confirm password should be same.", toastOptions);
      isvalid = false;
    }
    if (username.length < 3) {
      errormsgs.push("Username must be greater then 3 characters", toastOptions);
      isvalid = false;
    }
    ...
    if (email === "") {
      errormsgs.push("Email is required", toastOptions);
      isvalid = false;
    }
    if (isvalid == false) {
